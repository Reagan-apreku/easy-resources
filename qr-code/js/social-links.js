...
const socialLinksManager = (() => {
  ...
  const platforms = [
    { id: 'instagram', label: 'Instagram', icon: '📸', placeholder: 'username or URL' },
    { id: 'twitter', label: 'Twitter / X', icon: '🐦', placeholder: 'username or URL' },
    { id: 'linkedin', label: 'LinkedIn', icon: '💼', placeholder: 'profile URL or slug' },
    { id: 'tiktok', label: 'TikTok', icon: '🎵', placeholder: 'username or URL' },
    { id: 'facebook', label: 'Facebook', icon: '👥', placeholder: 'username or URL' },
    { id: 'youtube', label: 'YouTube', icon: '🎬', placeholder: 'channel handle or URL' },
    { id: 'github', label: 'GitHub', icon: '💻', placeholder: 'username or URL' },
    { id: 'snapchat', label: 'Snapchat', icon: '👻', placeholder: 'username or URL' },
    { id: 'pinterest', label: 'Pinterest', icon: '📌', placeholder: 'username or URL' },
    { id: 'telegram', label: 'Telegram', icon: '✈️', placeholder: 'username or URL' },
    { id: 'whatsapp', label: 'WhatsApp', icon: '💬', placeholder: 'phone number or URL' },
    { id: 'threads', label: 'Threads', icon: '🧵', placeholder: 'username or URL' },
    { id: 'discord', label: 'Discord', icon: '🎮', placeholder: 'invite code or URL' },
    { id: 'twitch', label: 'Twitch', icon: '🟣', placeholder: 'username or URL' },
    { id: 'spotify', label: 'Spotify', icon: '🎧', placeholder: 'user ID or URL' },
    { id: 'reddit', label: 'Reddit', icon: '🔗', placeholder: 'username or URL' },
    { id: 'behance', label: 'Behance', icon: '🎨', placeholder: 'username or URL' },
    { id: 'dribbble', label: 'Dribbble', icon: '🏀', placeholder: 'username or URL' },
  ];
